...
?>
                ...
                <div id="footer">
                    <p>Copyright &copy; <?php echo '<em>'."$name ".'</em>'.date('o').' year'; ?> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
                </div>
        </div>
    </body>
